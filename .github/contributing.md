# Contributing to jwt-auth

First and foremost, thank you! We appreciate that you want to contribute to jwt-auth, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for jwt-auth**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for jwt-auth:

- star the [project](https://github.com/Pterobyte/jwt-auth)
- tweet your support for jwt-auth
...
- **version**: (required) please note the version of jwt-auth are you using
...
The original poster or the maintainers of jwt-auth may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/jwt-auth
